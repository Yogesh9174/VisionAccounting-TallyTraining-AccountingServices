  ...
  const faculty = [
    {
      ...
      qualification: "M.Com, CA (Pursuing), Tally Certified",
      experience: "8+ Years",
    ...
    },
    {
      ...
      designation: "Senior Faculty - Accounts",
      qualification: "M.Com, NET, Tally Certified",
      experience: "5+ Years",
      specialization: "Financial Accounting, Taxation",
      image: "PS",
      courses: ["Diploma in Accounting", "Advanced GST"],
      achievements: [
    ...
    },
    {
      ...
      designation: "IT Faculty & Lab Coordinator",
      qualification: "BCA, MCA, Microsoft Certified",
      experience: "6+ Years",
      specialization: "Computer Applications, Software Training",
      image: "RK",
      courses: ["Basic Computer", "Tally Training"],
      achievements: [
