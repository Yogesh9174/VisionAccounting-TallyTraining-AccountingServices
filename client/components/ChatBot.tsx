...
export default function ChatBot({ className = "" }: ChatBotProps) {
  ...
  const generateBotResponse = (userMessage: string): Message => {
    ...
    if (
      ...
      response = `📚 We offer the following courses:\n\n• **GST Accounting with Placement** (3 months) - ₹15,000\n• **Tally Prime** (2 months) - ₹8,000\n• **Tally ERP 9** (2 months) - ₹7,000\n• **Basic Computer + Typing** (1.5 months) - ₹5,000\n• **Complete Package** (6 months) - ₹25,000\n\nAll courses include practical training, certificates, and job placement assistance!`;
